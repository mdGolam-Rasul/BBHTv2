...
go install -u github.com/j3ssie/metabigor
echo "${BLUE} done${RESET}"
...
go install  github.com/projectdiscovery/httpx/cmd/httpx@latest@latest
echo "${BLUE} done${RESET}"
echo ""
...
GO111MODULE=on go install  github.com/theblackturtle/fprobe@latest
echo "${BLUE} done${RESET}"
echo ""
...
GO111MODULE=on go install -v github.com/dwisiswant0/go-dork/...
echo "${BLUE} done${RESET}"
echo ""
